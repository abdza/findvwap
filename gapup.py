...
print("Prev Marks:",result_perc['prev_marks'].min(),":",result_perc['prev_marks'].max(),":",result_perc['prev_marks'].mean(),":",result_perc['prev_marks'].median())
print("Opening Marks:",result_perc['opening_marks'].min(),":",result_perc['opening_marks'].max(),":",result_perc['opening_marks'].mean(),":",result_perc['opening_marks'].median())
print("Late Marks:",result_perc['late_marks'].min(),":",result_perc['late_marks'].max(),":",result_perc['late_marks'].mean(),":",result_perc['late_marks'].median())
print("Early Marks:",result_perc['early_marks'].min(),":",result_perc['early_marks'].max(),":",result_perc['early_marks'].mean(),":",result_perc['early_marks'].median())
print("Marks:",result_perc['marks'].min(),":",result_perc['marks'].max(),":",result_perc['marks'].mean(),":",result_perc['marks'].median())
